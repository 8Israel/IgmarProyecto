...
export const routes: Routes = [
    ...
    {path: 'ver-armas', loadComponent: () => import('./components/view-armas/view-armas.component').then(va => va.ViewArmasComponent)},
    ...
    {path: 'form-misiones/:id', loadComponent: () => import('./components/nuevo-formulario-mision/nuevo-formulario-mision.component').then(fm => fm.NuevoFormularioMisionComponent)},
    {path: 'form-armas', loadComponent: () => import('./components/form-armas/form-armas.component').then(fa => fa.FormArmasComponent)},
    {path: 'form-armas/:id', loadComponent: () => import('./components/form-armas/form-armas.component').then(fa => fa.FormArmasComponent)},
